...
import { useHotelStepperHooks } from "./stepper/hooks";
import { renderHotelStepperContent } from "./stepper/renderContent";
...
export default function HotelStepper({
  ...
  const hooks = useHotelStepperHooks(subStep);
