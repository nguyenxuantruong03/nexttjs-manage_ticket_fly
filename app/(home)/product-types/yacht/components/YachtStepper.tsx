...
import { useYachtStepperHooks } from "./stepper/hooks";
import { renderYachtStepperContent } from "./stepper/renderContent";
...
export default function YachtStepper({
  mainStep,
  setMainStep,
  subStep,
  setSubStep,
}: Props) {
  const hooks = useYachtStepperHooks(subStep);
