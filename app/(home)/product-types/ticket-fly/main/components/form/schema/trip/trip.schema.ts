...
import { FlyConnectionSchema } from "./connection.schema";
import { FlyCrewScheduleSchema } from "@/app/(home)/product-types/references/airline/crew/main/components/schema/schedule.schema";
import { FlyCrewAssignmentSchema } from "@/app/(home)/product-types/references/airline/crew/main/components/schema/assignment.schema";
import { FlyItinerarySegmentSchema } from "./itinerary.schema";
