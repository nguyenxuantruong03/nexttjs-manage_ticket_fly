...
export default function PoliciesStep({
  ...
  return (
    <FormSection title="Policies" description="Flight policy values">
      <div className="grid gap-6 md:grid-cols-2">
        <FormEntitySelector<FlyFormSchema, Policy>
        ...
        <FormInput<FlyFormSchema>
          ...
          label="JSON Value"
        />
        <FormSwitch<FlyFormSchema> name="policies.0.active" label="Active" />
      </div>
    </FormSection>
  );
}
