...
export const busFieldGroups: Record<string, readonly BusFieldPath[]> = {
  ...
  pricing: [
    ...
    "price.0.breakdown.seatTypeId",
    "price.0.breakdown.basePrice",
    "price.0.breakdown.originalPrice",
    "price.0.breakdown.taxes",
    "price.0.breakdown.serviceFee",
    "price.0.breakdown.bookingFee",
    "price.0.breakdown.discount",
    "price.0.breakdown.finalPrice",
    "price.0.breakdown.availableSeats",
    "price.0.breakdown.includedItems",
    "price.0.breakdown.extraFees.0.extraFeeTypeId",
    "price.0.breakdown.extraFees.0.amount",
    "price.0.breakdown.extraFees.0.calculationType",
    "price.0.breakdown.extraFees.0.active",

    "price.0.priceRules.0.name",
    "price.0.priceRules.0.priceRuleTypeId",
    "price.0.priceRules.0.priority",
    "price.0.priceRules.0.combinable",
    "price.0.priceRules.0.percentage",
    "price.0.priceRules.0.amount",
    "price.0.priceRules.0.minimumSpend",
    "price.0.priceRules.0.maximumDiscount",
    "price.0.priceRules.0.couponCode",
    "price.0.priceRules.0.startDate",
    "price.0.priceRules.0.endDate",
    "price.0.priceRules.0.active",
  ],
