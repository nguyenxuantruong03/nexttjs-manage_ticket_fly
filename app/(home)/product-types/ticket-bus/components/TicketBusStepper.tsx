...
import { useTicketBusStepperHooks } from "./stepper/hooks";
import { renderTicketBusStepperContent } from "./stepper/renderContent";
...
export default function TicketBusStepper({
  mainStep,
  setMainStep,
  subStep,
  setSubStep,
}: Props) {
  const hooks = useTicketBusStepperHooks(subStep);
