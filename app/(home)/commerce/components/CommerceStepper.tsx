...
import { useCommerceStepperHooks } from "./stepper/hooks";
import { renderCommerceStepperContent } from "./stepper/renderContent";
...
export default function CommerceStepper({
  ...
  const hooks = useCommerceStepperHooks(subStep);
