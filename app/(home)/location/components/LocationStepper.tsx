...
import { useLocationStepperHooks } from "./stepper/hooks";
import { renderLocationStepperContent } from "./stepper/renderContent";
...
export default function LocationStepper({
  ...
  const hooks = useLocationStepperHooks(mainStep, subStep);
