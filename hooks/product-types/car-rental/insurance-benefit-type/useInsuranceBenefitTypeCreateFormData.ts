...
export const useCarRentalInsuranceBenefitTypeCreateFormData = (
  enabled = true,
) => {
  const query = useQuery({
    queryKey: ["car-rental-insurance-benefit-type-create-form-data"],
    enabled,
    staleTime: 1000 * 60 * 5,
  ...
  return {
    ...
    // key "insuranceBenefitType" để đồng bộ với update, phòng khi thêm
